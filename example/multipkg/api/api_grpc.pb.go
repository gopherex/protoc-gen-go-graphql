...
const (
	WidgetService_GetWidget_FullMethodName = "/multipkg.api.v1.WidgetService/GetWidget"
)
...
var WidgetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "multipkg.api.v1.WidgetService",
	...
	Metadata: "multipkg/api/api.proto",
}
