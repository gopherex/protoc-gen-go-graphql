...
func (r queryResolver) FetchScalars(ctx context.Context, input pb.GetScalarsRequest) (*pb.GetScalarsResponse, error) {
...
func (r mutationResolver) UpsertBook(ctx context.Context, input pb.UpsertBookRequest) (*pb.UpsertBookResponse, error) {
	resp, err := r.Library.UpsertBook(ctx, &input)
	if err != nil {
		return nil, graphqlpb.GraphQLError(ctx, err)
	}
	return resp, nil
